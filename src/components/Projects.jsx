...
const ProjectCard = ({ title, description, urlLabel }) => (
    <div className="p-0 group mb-6 last:mb-0">
        <h3 className="text-base font-bold mb-1 text-neutral-900 dark:text-neutral-100 transition-colors duration-200">{title}</h3>
